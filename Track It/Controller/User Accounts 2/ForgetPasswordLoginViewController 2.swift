...
class ForgetPasswordLoginViewController: UIViewController, UITextFieldDelegate
{
    static var storyBoardID = "ForgetPasswordLoginViewController"
...
extension ForgetPasswordLoginViewController
{
