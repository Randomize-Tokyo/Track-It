...
class AppDelegate: UIResponder, UIApplicationDelegate
{
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        Siren.shared.presentationManager = PresentationManager(alertTintColor: .systemBlue, appName: "Track it! - Package Tracker", alertTitle: "A New Version is Available", alertMessage: "A new version of the app is available. Please update as soon as possible. Thank you \n -Track it team❤️", updateButtonTitle: "Update", nextTimeButtonTitle: "Not Now", skipButtonTitle: "Skip this Version", forceLanguageLocalization: .none)
